 ...
 * context.
 */
public class MyGLThread extends Thread {
    private static final String TAG = "MyGLThread";
    private static final String THREAD_NAME = "mediapipe.glutil.MyGLThread";
     ...
     */
    public MyGLThread(@Nullable Object parentContext) {
     ...
     *     default ones.
     */
    public MyGLThread(@Nullable Object parentContext, @Nullable int[] additionalConfigAttributes) {
    ...
    public void bindFramebuffer(int texture, int width, int height) {
        Log.d("TEXT_NAME","Name: Texture binding "+texture);
    ...
    /**
     * Waits until the thread has finished setting up the handler and invoking .
     */
